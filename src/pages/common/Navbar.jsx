			...
			<nav className="navscroll navbar fixed-top navbar-expand-lg navbar-light py-2 px-3">
				<div className="container">
				  <NavLink className="navbar-brand" to="/">
					{/* <img src={} alt="logo1" className="img-fluid" width="160" /> */}
				  </NavLink>
				  <button className="navbar-toggler" type="button" data-togglogole="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
				  ...
				  <div className="collapse navbar-collapse" id="navbarSupportedContent">
				    <ul className="navbar-nav ml-auto">
				      ...
				      <li className="nav-item">
				        <NavLink exact className="nav-link" to="/service"><span className="d-lg-none d-xl-none mr-3"><DvrIcon /></span>Weather</NavLink>
				      </li>
				      <li className="nav-item">
				        <NavLink exact className="nav-link" to="/career"><span className="d-lg-none d-xl-none mr-3"><WorkIcon /></span>Analytics</NavLink>
				      </li>
				      <li className="nav-item">
